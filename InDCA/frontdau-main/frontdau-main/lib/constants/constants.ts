export const addressUSDC = "0x972aD3Fb93C9dFAE9B13e948AAfF0267f8C3e280";
export const addressDCA = "0xfed800b9d793d2D7630608EdaDaf753B1dcF1211";
export const addressETH = "0x334D98AE6277039B140ec334538089a49aCe87B5";
export const abiDCA = [
  { inputs: [], stateMutability: "nonpayable", type: "constructor" },
  {
    inputs: [
      { internalType: "enum DCA.Status", name: "indice", type: "uint8" },
    ],
    name: "Swap",
    outputs: [],
